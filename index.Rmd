...
```{r}
periods |> 
  ggplot( mapping = aes( x = Age, y = Padusers)) + geom_col(fill = "darkseagreen4") + labs( x = "Age of Particpant", y = "Number of Particpants Using Pads", title = "Number of Padusers by Age", caption = "Source: University of Liverpool")
